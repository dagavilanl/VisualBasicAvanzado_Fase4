<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PdfAWS.aspx.vb" Inherits="Fase4_Grupo27.PdfAWS" %>
        ...
        <div>
            ...
            <asp:Panel class="container" ID="Panel3" runat="server">
                ...
                <div class="container text-center">
                    <object data="index.pdf" type="application/pdf" width="800" height="600">
