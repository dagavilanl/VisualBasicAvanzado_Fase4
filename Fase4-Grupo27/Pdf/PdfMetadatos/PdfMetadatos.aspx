<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PdfMetadatos.aspx.vb" Inherits="Fase4_Grupo27.PdfMetadatos" %>
        ...
        <div>
            ...
            <asp:Panel class="container" ID="Panel3" runat="server">
                ...
                <div class="container text-center">
                    <object data="Metadatos.pdf" type="application/pdf" width="800" height="600">
                        <p> No se puede mostrar el archivo PDF. <a href="Metadatos.pdf"> Descargar </a> en su lugar. </p>
                    </object>
                </div>
            </asp:Panel>
            <br />
