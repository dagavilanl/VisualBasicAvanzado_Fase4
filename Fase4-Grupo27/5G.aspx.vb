Public Class _5G
    ...
    Protected Sub BtnEnv_Click(sender As Object, e As EventArgs) Handles BtnEnv.Click
        ...
        respuestas(0) = "Hasta 10 GBps"
        respuestas(1) = "El tiempo de respuesta de la red"
        respuestas(2) = "La comunicación entre objetos cotidianos y nosotros"
        respuestas(3) = "La seguridad, la privacidad, la sostenibilidad y la brecha digital"
        respuestas(4) = "En algunos países y regiones del mundo"
        ...
        Select Case puntaje
            Case Is < 3
                Response.Redirect("Notas5G/Nota 1.aspx")
            Case 5
                Response.Redirect("Notas5G/Nota 3.aspx")
            Case Is < 5
                Response.Redirect("Notas5G/Nota 2.aspx")
            Case Else
                MsgBox("Error")
        End Select
    End Sub
    ...
    Protected Sub BtnVideo_Click(sender As Object, e As EventArgs) Handles BtnVideo.Click
        Response.Redirect("Videos/5G/Video.aspx")
    End Sub

    Protected Sub BtnPdf_Click(sender As Object, e As EventArgs) Handles BtnPdf.Click
        Response.Redirect("Pdf/Pdf5G/Revolucion5g.aspx")
    End Sub
    ...
    Protected Sub BtnAudio_Click(sender As Object, e As EventArgs) Handles BtnAudio.Click
        Response.Redirect("Audios_podcasts/5G/audio5g.aspx")
    End Sub

    Protected Sub BtnImage_Click(sender As Object, e As EventArgs) Handles BtnImage.Click
        Response.Redirect("Images/5G/Imagen.aspx")
    End Sub
End Class