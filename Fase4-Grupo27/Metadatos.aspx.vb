Public Class Metadatos
    ...
    Protected Sub BtnEnv_Click(sender As Object, e As EventArgs) Handles BtnEnv.Click
        ...
        respuestas(0) = "C. Describir los datos y la información"
        respuestas(1) = "D. Ninguna de las anteriores."
        respuestas(2) = "A. Un conjunto de reglas que definen cómo se describen los metadatos."
        respuestas(3) = "A. Ayudar a los usuarios a encontrar y recuperar información."
        respuestas(4) = "A. Información que describe los datos"
        ...
        Select Case puntaje
            Case Is < 3
                Response.Redirect("NotasAWS/Nota 1.aspx")
            Case 5
                Response.Redirect("NotasAWS/Nota 3.aspx")
            Case Is < 5
                Response.Redirect("NotasAWS/Nota 2.aspx")
            Case Else
                MsgBox("Error")
        End Select
    End Sub
    ...
    Protected Sub BtnVideo_Click(sender As Object, e As EventArgs) Handles BtnVideo.Click
        Response.Redirect("Videos/Metadatos/Video.aspx")
    End Sub

    Protected Sub BtnPdf_Click(sender As Object, e As EventArgs) Handles BtnPdf.Click
        Response.Redirect("Pdf/PdfMetadatos/PdfMetadatos.aspx")
    End Sub
End Class