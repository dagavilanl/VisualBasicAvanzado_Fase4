<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Img_Aws.aspx.vb" Inherits="Fase4_Grupo27.Img_Aws" %>
        ...
        <div>
            ...
            <asp:Panel class="container" ID="Panel3" runat="server">
                ...
                <div class="container text-center"> 
                    <img src="AWS.png" width="800" height="600" class="text-center"/> 
                </div>
            </asp:Panel>
            <br />
